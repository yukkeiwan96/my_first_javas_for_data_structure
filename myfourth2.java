...
/* QuickSortA reads in a line of integers from a text file which is then split into an array
 * It uses the first element as pivot
 * It has a partition size of 1 and 2
 * quicksorta sorts the array iteratively.
 */
public class QuickSortA {
    ...
    public void quicksorta (int arr[], int l, int h){
  ...
  public static void main (String args[]) throws IOException {
    ...
    //  Open the files that will be used for input and output, and writes the output file.
     try{
        ...
        int[] a= nums;
        outputStream.write("Quick Sort: partition size 1 and 2. First item as pivot."+"\r\n");
        long startTimed = System.nanoTime();
        qa.quicksorta(nums, 0, le-1);
